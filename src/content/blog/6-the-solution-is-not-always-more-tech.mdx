...
id: 6
slug: the-solution-is-not-always-more-tech
 ---
---

import { Picture } from 'astro:assets'
import coffee from '../../assets/0*DhlgH5_-e1vlJ66R.jpg'
import varGoal from '../../assets/1*WhewX4GX7lE2h6vgrDF-pg.png'
import uiDesign from '../../assets/1*pO790K3gJLzR7rBSDS7uJw.jpeg'
import giphysloth from '../../assets/giphysloth.gif'
import kindleAndIphone from '../../assets/1*xziQKhzu5hmxQKIzgXtV5A.jpeg'

<Picture src={coffee} alt="Coffee" densities={[1.5, 2]} />
...
<Picture src={varGoal} alt="VAR checking goal in a soccer match" densities={[1.5, 2]} />
...
<Picture src={uiDesign} alt="People collaborating on UI design" densities={[1.5, 2]} />
...
<Picture src={giphysloth} alt="Cute sloth yawning" densities={[1.5, 2]} />
...
<Picture src={kindleAndIphone} alt="Kindle and iPhone" densities={[1.5, 2]} />
