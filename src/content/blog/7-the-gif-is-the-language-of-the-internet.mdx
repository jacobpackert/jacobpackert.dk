...
id: 7
slug: the-gif-is-the-language-of-the-internet
---
...
<Picture src={giphySearchFriday} alt="Giphy search for the keyword 'friday'." densities={[1.5, 2]} />
...
<Picture src={captainAmerica} alt="I understood that reference gif from Captain America" densities={[1.5, 2]} />
...
<Picture src={olsenbanden} alt="GIF from the Olsen Banden Danish movie series" densities={[1.5, 2]} />
...
<Picture src={olsenbanden2} alt="A GIF from the movie Olsen Banden, two men waving with flags in celebration" densities={[1.5, 2]} />
